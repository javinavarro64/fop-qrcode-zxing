...
/**
 * Created with IntelliJ IDEA. User: hobbut Date: 11.02.12 Time: 15:24
 */
...
public class QRCodeElement extends QRCodeObject {
	...
	public Point2D getDimension(Point2D view) {
		Properties configuration = ConfigurationUtil.toProperties(getDOMDocument().getDocumentElement());
