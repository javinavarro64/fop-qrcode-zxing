...
/**
 * Created with IntelliJ IDEA. User: hobbut Date: 11.02.12 Time: 15:15
 */
@Deprecated
public class QRCodeXMLHandler implements XMLHandler {
	...
	public void handleXML(RendererContext rendererContext, Document document, String s) throws Exception {
		Properties cfg = ConfigurationUtil.toProperties(document.getDocumentElement());

		String msg = cfg.getProperty(MESSAGE_ATTRIBUTE);
